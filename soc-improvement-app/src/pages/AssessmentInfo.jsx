...
const AssessmentInfo = ({ onBack, onOpenReporting, onOpenContinuousImprovement, onOpenOperatingModel, metaRef, scoresRef, actionPlanRef, onDeleteAssessment, onNavigateHome, onSwitchWorkspace, onOpenApiModal, onOpenPreferences, workspace, assessments = [], currentAssessmentId, onSwitchAssessment }) => {
